    ...
    InputValues.forEach((value, index) => {
      ...
      // to add re tables
        ...
        if ('Geometry' in table) {
          delete table.Geometry;
          table.ColumnConfiguration.forEach((value: { Box: any; }) => {
            delete value.Box;
          });
        }
    ...
    boxes.forEach((boxx, index) => {
      ...
      if (boxx != '') {
        ...
        // to add whole table Geometry
          ...
          if ('StartRegEx' in table) {
            delete table.StartRegEx;
            delete table.EndRegEx;
            delete table.RowReg;

            table.ColumnConfiguration.forEach((value: { RegEx: any; }) => {
              delete value.RegEx;
            });
          }
